...
export default function HeroSection() {
  ...
  return (
    <header className="relative md:min-h-[calc(90vh)] m-2 rounded-2xl bg-transparent bg-[url('/assets/img/hero-img-news.png')] bg-cover bg-center pb-8 md:p-0">
        <div className='absolute z-[4] inset-0 bg-green opacity-10' />
        <div className='max-width pb-10'>
            <div className="flex flex-col md:w-1/2 lg:w-1/3 items-start gap-11 pt-36 md:pt-56">
