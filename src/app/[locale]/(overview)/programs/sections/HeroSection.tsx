...
export default function HeroSection() {
  return (
    <header className="relative h-[calc(75vh)] m-2 rounded-2xl bg-transparent bg-[url('/assets/img/hero-img-programs.png')] bg-cover bg-center">
        <div className='absolute z-[4] inset-0 bg-green opacity-10' />
        <div className="flex flex-col w-1/3 items-start gap-11 pt-48 pl-[90px] z-10">
