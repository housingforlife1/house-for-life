...
export default function MissionSection() {
    ...
    return (
        <div className="py-[140px] bg-[#f8f8e9] w-full my-32">
            <div className='flex flex-col items-start gap-[120px] max-width'>
                {/* Mission Statement */}
                <div className="grid grid-cols-12 w-full gap-8">
                    <div className="flex flex-col col-span-4 items-start gap-11">
                        ...
                        <Button className="h-[50px] px-5 py-3.5 bg-green rounded-[54px] text-white font-paragraph-bold text-[length:var(--paragraph-bold-font-size)] tracking-[var(--paragraph-bold-letter-spacing)] leading-[var(--paragraph-bold-line-height)] [font-style:var(--paragraph-bold-font-style)]">
                            Soutenir la&nbsp;&nbsp;mission
                        </Button>
                    </div>
                    <div className='relative col-span-3 h-[448px] rounded-2xl overflow-hidden'>
                        <Image
                    ...
                    <div className='relative col-span-5 h-[448px] rounded-2xl overflow-hidden'>
                        <Image
                            className="object-cover"
                            alt="Image"
                ...
                {/* Support Section */}
                <div className="flex flex-col w-full items-start gap-[34px]">
                    <div className="flex flex-col items-start gap-4 w-full">
                        <h2 className="font-extrabold text-black text-[length:var(--heading-2-font-size)] tracking-[var(--heading-2-letter-spacing)] leading-[var(--heading-2-line-height)] whitespace-nowrap [font-style:var(--heading-2-font-style)]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 h-[340px] w-full">
