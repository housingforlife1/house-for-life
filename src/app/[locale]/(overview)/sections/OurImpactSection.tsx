...
export default function OurImpactSection() {
    ...
    return (
        <div className="grid grid-cols-8 max-width gap-10 my-32">
            <div className='col-span-3 relative h-full rounded-3xl overflow-hidden'>
                <Image
            ...
            <div className="col-span-5 grid grid-cols-2 gap-8">
                ...
                <Card
                    key={index}
                    className={`${card.bgColor} rounded-3xl border-none shadow-none ${index === 0 ? "h-[224px]" : "h-[240px]"}`}>
